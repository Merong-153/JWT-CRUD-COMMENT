...
import com.sparta.merong.repository.BlogRepository;
import com.sparta.merong.repository.CommentRepository;
import com.sparta.merong.repository.MemberRepository;
import com.sparta.merong.util.SecurityUtil;
...
public class CommentService {
    ...
    private final BlogRepository postRepsitory;
    ...
    public Long createComment(Long postId, CommentRequestDto commentRequestDto) {
        ...
        //작성된 글
        Blog post = postRepsitory.findById(postId).orElseThrow(()-> new IllegalArgumentException("해당 게시글을 찾을 수 없습니다."));
